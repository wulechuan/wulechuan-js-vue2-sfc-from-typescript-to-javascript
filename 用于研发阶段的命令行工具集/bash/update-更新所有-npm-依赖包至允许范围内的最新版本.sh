...
function 完整流程 {
    ...
    Update-吴乐川更新当前_npm_项目的所有依赖包 \
        --某产品级依赖包之版本配置 "    @wulechuan/get-valid-indentation-string   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "        @wulechuan/vue2-official-sfc-parser   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                      chalk   |:|   ^4       |:|   chalk 不能更新至第 5 或更晚的版本。因为自第 5 版始， chalk 仅支持 ES Module 语法。" \
        --某产品级依赖包之版本配置 "                                   hash-sum   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                     indent   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                  indent.js   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                       less   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                        pug   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                       sass   |:|   latest   |:|" \
        --某产品级依赖包之版本配置 "                                     stylus   |:|   latest   |:|" \
        ...
        --某研发级依赖包之版本配置 "                                        vue   |:|   ^2c      |:|   本工具只适用于 Vuejs 第 2 版。" \
